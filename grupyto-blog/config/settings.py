# -*- coding: utf-8 -*-
"""
Django settings for grupyto-blog project.
...
class Common(Configuration):
    ...
    ADMINS = (
        ('Fabio Caritas Barrionuevo da Luz', 'bnafta@gmail.com'),
    )
    ...
    DATABASES = values.DatabaseURLValue('postgres://localhost/grupyto-blog')
...
class Local(Common):
    ...
    DATABASES = {
            'default': {
                ...
                'NAME': 'grupyto',                      # Or path to database file if using sqlite3.
                'USER': 'sgt',                      # Not used with sqlite3.
                'PASSWORD': 'sgt',                  # Not used with sqlite3.
...
class Production(Common):
    ...
    EMAIL_SUBJECT_PREFIX = values.Value('[grupyto-blog] ', environ_name="EMAIL_SUBJECT_PREFIX")
    EMAIL_USE_TLS = True
